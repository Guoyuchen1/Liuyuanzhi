...
modified_RestNet50 = tf.keras.applications.resnet.ResNet50(weights='imagenet', include_top=False,
...
class Transformer(tf.keras.Model):
    ...
    def call(self, inp, tar, training, enc_padding_mask,
        ...
        dec_output, attention_weights = self.decoder(tar, last, feature_map, training, look_ahead_mask,
                                                     dec_padding_mask)
